...
from app.lib.environment import TRAEFIK_HTTP_ENTRYPOINT, TRAEFIK_NETWORK, TRAEFIK_HTTPS_ENTRYPOINT, TRAEFIK_CERTRESOLVER
...
async def create_container(
    ...
    labels = {
        "traefik.enable": "true",
        f"traefik.http.routers.http-{project_id}.entrypoints": TRAEFIK_HTTP_ENTRYPOINT,
    ...
    if TRAEFIK_HTTPS_ENTRYPOINT is not None:
        labels = dict(labels, **{
            ...
            f"traefik.http.routers.https-{project_id}.entrypoints": TRAEFIK_HTTPS_ENTRYPOINT,
            ...
            f"traefik.http.routers.https-{project_id}.tls.certresolver": TRAEFIK_CERTRESOLVER,
        })
